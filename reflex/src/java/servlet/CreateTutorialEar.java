...
public class CreateTutorialEar extends HttpServlet {
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out1 = response.getWriter()) {
            ...
            String photo="";
            String path= getServletContext().getRealPath("/imageear");
            ...
            String sql1 = "Select * from tutorialear";
            ...
            String sql2 = "INSERT into tutorialear values (?,?,?,?)";
