		...
		<div class="row 200%">
                ...
                <%
                    ...
                    try {
                        ...
                        String sql = "select * from tutorialhand where id='" + id + "'";
			...
			<section>
                            <header>
                                <center><h3><a>HAND FUN FACTS</a></h3><br></center>
                            </header>
                            <div class="row 50%">
				<div class="12u">
                                    <p>	
				...
				<div class="12u">
                                    <p>	
                                        *Hand surgeons say that the index finger is the best one to lose if you had a choice. 
                                        The index finger is needed the least.
                                    </p>
				</div>
                            </div>
                            <div class="row 50%">
				<div class="12u">
                                    <p>	
                                        *Our fingers are even more sensitive than the eyes. The fingertips have a large number 
                                        of receptors responsible for sending messages to the brain.
                                    </p>
				</div>
                            </div>
			</section>
