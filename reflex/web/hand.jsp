    ...
    <body class="no-sidebar">
        <%
            ...
            try {
                ...
                if (search == null) {
                    sql = "Select * from tutorialhand";
                } else if (search.equals("1")) {
                    sql = "Select * from tutorialhand where name like '%" + ailment + "%'";
                }
			...
			<!-- Main -->
				<div class="wrapper style1">
					...
					<article id="main" class="special">
                                            <header>
						<h2><a>Hand Reflexology</a></h2>
						<p>
                                                    Hand reflexology can be preferred for the start or end of a foot reflexology treatment. 
                                                    It can also be applicable as a stand-alone treatment in its own right.
						</p>
                                            </header>
                                            <center><a class="image featured"><img src="images/hand.jpg" alt="" style="width:80%; height:50%;"/></a></center>
					</article>
                                    </div>
				</div>
					...
					<header>
                                ...
                                <div class="reel">
                                    ...
                                    <article>
                                        <a class="image fit" >
                                            <%                                    
                                                out.print("<img src=\"imagehand/" + rset.getString("name") + ".jpg\" alt=\"\" />");
                                            %>
                                        </a>
                                        <header>
                                            <% 
                                                out.print("<a href='tutorialhand.jsp?id=" + rset.getString("id") + "'>"); 
                                            %>
                                            <%= rset.getString("name") %>
                                            <% 
                                                out.print("</a>"); 
				...
				<div class="wrapper style1">
					...
					<article id="main" class="special">
						...
						<h2><a>Hand Reflexology</a></h2>
                                        ...
                                        <form action="hand.jsp">
                                            <center><a href="createTutorialHand.jsp" class="button"> ADD</a></center>
                                        </form>
                                        </article>
                                    </div>
				</div>
                                ...
                                <section class="post">
                                    ...
                                    <article><center>
                                        <div class="6u 12u(small)">
                                            ...
                                            <ul>
                                                <li><% out.print("<li><a href='editTutorialHand.jsp?id=" + rset.getString("id") + "' class=\"button\">EDIT</a></li>"); %></li>
                                                <li><% out.print("<li><a href='DeleteTutorialHand?id=" + rset.getString("id") + "' class=\"button\">DELETE</a></li>"); %></li>
                                            </ul>
                                            <br>
