...
<html>
	...
	<div id="main">
                <!-- Post -->
                <section class="post">
                    <form method="post" action="UpdateTutorialFoot" class="alt">
                        ...
                        <div class="row uniform">
                            ...
                            <div class="6u 12u(xsmall)">
                                <label for="tutorialfoot">Name of Ailment</label>
                                <input type="text" name="name"  value="<%=rset.getString("name")%>">
                            </div>
                            <div class="6u 12u(xsmall)">
                                <label for="tutorialfoot">Description</label>
                                <input type="text" name="description" value="<%=rset.getString("description")%>">
                            </div>
                            <div class="6u 12u(xsmall)">
                                <label for="tutorialfoot">Steps</label>
                                <input type="text" name="steps"  value="<%=rset.getString("steps")%>">
                            </div>
                            <div class="6u 12u(xsmall)">
                                <label for="tutorialfoot">Video</label>
                                <input type="text" name="video" value="<%=rset.getString("video")%>">
                            </div>
