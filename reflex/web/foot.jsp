    ...
    <body class="no-sidebar">
        <%
            ...
            try {
                ...
                if (search == null) {
                    sql = "Select * from tutorialfoot";
                } else if (search.equals("1")) {
                    sql = "Select * from tutorialfoot where name like '%" + ailment + "%'";
                }
			...
			<!-- Main -->
				<div class="wrapper style1">
					...
					<article id="main" class="special">
						...
						<p>
                                                    Reflexology foot therapy involves applying pressure to certain points in the feet, 
                                                    which corresponds to various parts of the body to decrease pain and promote good health. 
						</p>
                                            </header>
                                            <center><a class="image featured"><img src="images/foott.jpg" alt="" style="width:80%; height:50%;"/></a></center>
					</article>
                                    </div>
				</div>
					...
					<header>
                                ...
                                <div class="reel">
                                    ...
                                    <article>
                                        ...
                                        <header>
                                            <% 
                                                out.print("<a href='tutorialfoot.jsp?id=" + rset.getString("id") + "'>"); 
                                            %>
                                            <%= rset.getString("name") %>
                                            <% 
                                                out.print("</a>"); 
				...
				<div class="wrapper style1">
					...
					<article id="main" class="special">
						...
						<h2><a>Foot Reflexology</a></h2>
                                        ...
                                        <form action="foot.jsp">
                                            <center><a href="createTutorialFoot.jsp" class="button"> ADD</a></center>
                                        </form>
                                        </article>
                                    </div>
				</div>
                                ...
                                <section class="post">
                                    ...
                                    <article><center>
                                        <div class="6u 12u(small)">
                                            ...
                                            <ul>
                                                <li><% out.print("<li><a href='editTutorialFoot.jsp?id=" + rset.getString("id") + "' class=\"button\">EDIT</a></li>"); %></li>
                                                <li><% out.print("<li><a href='DeleteTutorialFoot?id=" + rset.getString("id") + "' class=\"button\">DELETE</a></li>"); %></li>
                                            </ul>
                                            <br>
